...
class MediaFile:
    ...
    def create_table_index_sql() -> str:
        """索引SQL"""
        return "CREATE INDEX IF NOT EXISTS idx_file_path ON media_files (file_path)"
...
class VideoFrame:
    ...
    def create_table_index_sql() -> str:
        """索引SQL"""
        return "CREATE INDEX IF NOT EXISTS idx_media_file_id ON video_frames (media_file_id)"
...
class FilePathDao:
    ...
    def create_table() -> None:
        ...
        try:
            ...
            conn.rollback()
            log.exception("Error creating file_paths table: ")
        finally:
            cursor.close()
    ...
    def add_file_path(file_path: str) -> bool:
        ...
        try:
            ...
            conn.rollback()
            log.exception("Error adding file path: ")
        finally:
            cursor.close()
        return False
    ...
    def get_indexed_folders() -> List[str]:
        ...
        try:
            ...
            log.exception("Error getting indexed folders:")
        finally:
            cursor.close()
        return []
...
class MediaFileDao:
    ...
    def create_table() -> None:
        ...
        try:
            ...
            cursor.execute(MediaFile.create_table_index_sql())
            conn.commit()
            log.info("Created media_files table")
        except Exception as e:
            conn.rollback()
            log.exception("Error creating media_files table: ")
        finally:
            cursor.close()
    ...
    def is_file_indexed(file_path: str) -> bool:
        ...
        cursor = SQLiteDB().get_cursor()
        try:
            cursor.execute("SELECT COUNT(*) as count_1 FROM media_files WHERE file_path = ?", (file_path,))
            count = cursor.fetchone()
            if count is None or count[0] is None:
                return False
            return count[0] > 0
        except Exception as e:
            log.exception("检查文件是否已编入索引时出错:")
        finally:
            cursor.close()
        return False
    ...
    def is_empty() -> bool:
        ...
        try:
            ...
            log.exception("Error checking if database is empty: ")
        finally:
            cursor.close()
        return True
    ...
    def get_media_files_by_id(id: int) -> MediaFile:
        ...
        try:
            ...
            log.exception("Error getting media file by id: ")
        finally:
            cursor.close()
        return None
    ...
    def get_media_files_by_folder(folder_path: str) -> List[str]:
        ...
        try:
            ...
            log.exception("Error getting media files by folder: ")
        finally:
            cursor.close()
        return []
    ...
    def get_media_files_by_file_path(file_path: str) -> List[MediaFile]:
        ...
        try:
            ...
            log.exception("Error getting media file by file_path: ")
        finally:
            cursor.close()
        return []
    ...
    def delete_media_file(media_file: MediaFile):
        ...
        try:
            ...
            conn.rollback()
            log.exception("Error deleting media file: ")
        finally:
            cursor.close()
...
class VideoFrameDao:
    ...
    def create_table() -> None:
        ...
        try:
            ...
            cursor.execute(VideoFrame.create_table_index_sql())
            conn.commit()
            log.info("video_frames table created")
        except Exception as e:
            conn.rollback()
            log.exception("Error creating video_frames table: ")
        finally:
            cursor.close()
    ...
    def add_video_frame(media_file_id: int, frame_number: int, timestamp: float, frame_path: str, file_path: str, feature_list: List[float] = None) -> VideoFrame:
        ...
        try:
            ...
            conn.rollback()
            log.exception("Error adding video frame: ")
    ...
    def get_video_frames_by_media_file_id(media_file_id: int) -> List[VideoFrame]:
        ...
        try:
            ...
            log.exception("Error getting video frames by media_file_id: ")
        finally:
            cursor.close()
        return []
    ...
    def delete_video_frame(video_frame: VideoFrame):
        ...
        try:
            ...
            conn.rollback()
            log.exception("Error deleting video frame: ")
        finally:
            cursor.close()
    ...
    def delete_video_frame_by_id(video_frame_id: int) -> None:
        ...
        try:
            ...
            conn.rollback()
            log.exception("Error deleting video frame by id: ")
        finally:
            cursor.close()
